...
namespace sifoodprojectformal2._0.Areas.Users.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        private BankInfoModel _bankInfoModel = new BankInfoModel
        {
            ...
            NotifyURL = "https://ef0a-1-164-232-96.ngrok-free.app/Bank/SpgatewayNotify",
            ReturnURL = "/Home/RealTimeOrders",
        ...
        public IActionResult TakeOutOrder([FromBody] CreateTakeOutOrderVM model)
        {
